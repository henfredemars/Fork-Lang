  ...
  for file in temp_files:
    if args.v:
      ...
      if args.c:
        ...
        os.system("llvm/build/Release+Asserts/bin/opt -O2 {0}.ll > {0}.bc".format(basename))
        os.system("llvm/build/Release+Asserts/bin/llc -O2 {0}.bc; echo ; cat {0}.s".format(basename))
